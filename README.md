### [Temporary: solutions for a known bug that prevents WKE from running](https://github.com/AxtMueller/Windows-Kernel-Explorer/tree/master/binaries#emergency-notification)
***
# Introduction
